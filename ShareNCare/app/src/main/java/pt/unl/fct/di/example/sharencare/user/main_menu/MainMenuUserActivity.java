...
public class MainMenuUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_profile, R.id.nav_events, R.id.nav_tracks, R.id.nav_find_tracks)
    ...
    public void setPopup(){
        ...
        location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Autocomplete.IntentBuilder(AutocompleteActivityMode.OVERLAY, fieldList).build(MainMenuUserActivity.this);
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            fragment.setArguments(args);
                args.putString("filters", gson.toJson(f));*/
                HomeFragment fragment = new HomeFragment();
                FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.nav_home, fragment);
                HomeFragment.newInstance(gson.toJson(f));
                transaction.commit();
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable @org.jetbrains.annotations.Nullable Intent data) {
        ...
        if(requestCode == 100 && resultCode == MainMenuUserActivity.RESULT_OK) {
            ...
            coordinates = gson.toJson(place.getLatLng().latitude + " " + place.getLatLng().longitude);
        } else {
