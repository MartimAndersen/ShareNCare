...
//	public byte[] profilePic;
    ...
    public ChangePropertyData(String newEmail, String newProfileType, String newLandLine, String newMobile, String newAddress, String newSecondAddress, String newPostal/**, byte[] profilePic*/, String bio) {
...
//		this.profilePic = profilePic;
    ...
    public boolean allEmptyParameters() {
        return newEmail.equals("") && newLandLine.equals("") && newMobile.equals("")
                ...
                && newProfileType.equals("") && newBio.equals("");
    }
}
